...
const Order = ({ handleClose }: WindowDishesProps) => {
  ...
  return (
    <div className="custom-scrollbar-1 flex h-[calc(100vh-100px)] flex-col-reverse gap-8 overflow-y-auto text-2xl md:flex-row">
      <button
        onClick={handleClose}
      ...
      <div className="flex w-5/10 flex-col items-center">
      ...
      <div className="flex w-5/10 flex-col text-xl">
