...
export default function ProfileClientComponent() {
  ...
  const avatarIcon = "/images/icons/user.png";
          ...
          <section className="mx-auto mt-30 max-w-[1370px] px-2 lg:mt-52">
            ...
            <div className="flex w-full flex-col items-center justify-between lg:flex-row lg:items-start">
              ...
              >
                ...
                <div className="relative h-56 w-56 rounded-[55px] border-4 border-[#F2680F]">
                  <Image
                    src={userData?.avatar ? userData?.avatar : avatarIcon}
                    alt="User Profile"
                    fill
                    sizes="230px"
            ...
            <h1
              className="font-karantina relative z-20 mt-10 text-center text-8xl"
              data-aos="fade-up"
            >
              Orders
            </h1>
